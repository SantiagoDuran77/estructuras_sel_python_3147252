...
trabajadores entre los siguientes:
a - Contrato a termino indefinido
b - Contratode prestaciones de      
    servcios
...
=> Jornal:
   ...
   se les da una bonificacion del 10%
   => Contarto de Aprendizaje
   ...
   => Contrato por prestacion de servicios:
    ...
    -Si la antiguedad es mayor a 5 años
      se le aumenta elñ 10% al salario mensual
    Descuentos de ley
    - 8% de salud
    - 10% de pension
    - 1% de caja de compensacion 
    => Contato a termino indefinido
    el salario mensual se calcula
    con base en la siguiente tabla
    de escalafones o gradops:
    - 1: 1.5 veces el SMLV
    - 2: 1.7 veces el SMLV
    - 3: 2 veces el SMLV
    - 4: 2.5 veces el SMLV
...
#y asignada en cualquier parter del
#programa
...
if tipo_empleado == "a":
    print("Ha ingresado termino indefinido")
